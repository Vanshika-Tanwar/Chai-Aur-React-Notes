...
function App() {
  ...
  //useEffect: lets us synchronize a component with an external system.
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-yellow-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          <input type="text"
            ...
            readOnly
            ref={passwordRef}/>
            <button onClick={copyPasswordToClipboard} className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:bg-blue-800'>Copy</button>
        </div>
